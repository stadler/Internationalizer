...
public class SingleContactInternationalizerActivity extends ListActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Contact[] contactsStringArray = contactsList.toArray(new Contact[contactsList.size()]);
    setListAdapter(new ArrayAdapter<Contact>(this, R.layout.contact_list_item, contactsStringArray));
